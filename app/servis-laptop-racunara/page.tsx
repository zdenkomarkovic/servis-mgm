  ...
  return (
    <div className=" py-32 mx-auto space-y-6 md:space-y-12">
      <div className="container px-2 md:px-4 mx-auto space-y-6 md:space-y-12">
        <h1>{pages.laptop.title}</h1>
        <p className="px-32 text-center">{pages.laptop.text}</p>
        <div className="flex gap-3 md:gap-12 items-center justify-center">
          <div>
            {pages.laptop.description && (
              <p className="font-bold text-primary">
                {pages.laptop.description}
              </p>
            )}
            <ul>
              {pages.laptop.lines.map((line, i) => {
          ...
          >
            <Image
              src={pages.laptop.image}
              width={500}
              height={500}
              alt={pages.laptop.alt}
            />
          </motion.div>
        </div>
